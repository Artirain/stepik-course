...
### Установка расширения WSL

1. Открой VS Code
2. Нажми ++ctrl+shift+x++ (или кликни на иконку расширений слева)
3. В поиске напиши `WSL`
4. Найди расширение **WSL** от Microsoft (синяя иконка с пингвином и надписью `><`)
5. Нажми **Install**

!!! warning "Не перепутай с Remote - SSH"
    Расширение **Remote - SSH** — для подключения к удалённым серверам. Тебе нужно именно **WSL** для работы с локальным Linux.
