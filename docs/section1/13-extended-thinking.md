...
Extended thinking включается автоматически для моделей, которые его поддерживают. Claude Code сам решает, когда задействовать расширенное мышление — обычно на сложных задачах.

Если ты хочешь явно усилить мышление, используй подробные промпты: «продумай архитектуру», «проанализируй все зависимости», «рассмотри edge cases».
